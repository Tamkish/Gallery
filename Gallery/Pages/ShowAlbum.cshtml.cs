...
namespace Gallery.Pages
{
    public class ShowAlbumModel : PageModel
    {
        ...
        public IActionResult OnGet([FromQuery(Name = "aId")] string aId /*album id (unique name)*/,
            [FromQuery(Name = "uId")] string uId /*user id*/)
        {
            var userId = "";
            ...
            else
            {
                ...
                foreach (var photo in Album.Files) _context.Entry(photo).Collection(a => a.Thumbnails).Load();
